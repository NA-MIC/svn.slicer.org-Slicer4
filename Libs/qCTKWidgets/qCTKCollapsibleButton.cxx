...
//-----------------------------------------------------------------------------
class qCTKCollapsibleButtonPrivate : public ctkPrivate<qCTKCollapsibleButton>
{
public:
  CTK_DECLARE_PUBLIC(qCTKCollapsibleButton);
  void init();
...
{
  CTK_D(const qCTKCollapsibleButton);
  if (option == 0)
    {
    return;
    }
...
{
  CTK_INIT_PRIVATE(qCTKCollapsibleButton);
  ctk_d()->init();
}
