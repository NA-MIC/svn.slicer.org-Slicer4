...
//-----------------------------------------------------------------------------
class qCTKDoubleSliderPrivate: public ctkPrivate<qCTKDoubleSlider>
{
  public:
...
{
  CTK_INIT_PRIVATE(qCTKDoubleSlider);
  ctk_d()->init();
}
