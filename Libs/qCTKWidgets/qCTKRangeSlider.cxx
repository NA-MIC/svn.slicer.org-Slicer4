...
class qCTKRangeSliderPrivate:public ctkPrivate<qCTKRangeSlider>
{
public:
...
qCTKRangeSlider::qCTKRangeSlider(QWidget* parent) 
  : QSlider(parent)
{
  CTK_INIT_PRIVATE(qCTKRangeSlider);
  ctk_d()->init();
}
