...
vtkCxxRevisionMacro(vtkKWMimxDeleteBoundaryConditionsGroup, "$Revision: 1.2 $");
...
void vtkKWMimxDeleteBoundaryConditionsGroup::CreateWidget()
{
  ...
  this->StepNumberComboBox->SetParent(this->MainFrame->GetFrame());
...
/*
  ...
  this->DoneButton->SetCommand(this, "DeleteBoundaryConditionDoneCallback");
  this->GetApplication()->Script(
    "pack %s -side left -anchor nw -expand y -padx 20 -pady 6", 
