...
vtkCxxRevisionMacro(vtkKWMimxMergeBBGroup, "$Revision: 1.23 $");
...
void vtkKWMimxMergeBBGroup::CreateWidget()
{
  ...
  this->MergeTolerence->SetParent(this->MainFrame->GetFrame());
...
/*
  ...
  this->DoneButton->SetCommand(this, "MergeBBDoneCallback");
  this->GetApplication()->Script(
    "pack %s -side left -anchor nw -expand y -padx 20 -pady 6", 
