...
vtkCxxRevisionMacro(vtkKWMimxCreateFEMeshNodeSetGroup, "$Revision: 1.14 $");
...
void vtkKWMimxCreateFEMeshNodeSetGroup::CreateWidget()
{
  ...
  this->NodeSetNameEntry->SetParent(this->MainFrame->GetFrame());
...
int vtkKWMimxCreateFEMeshNodeSetGroup::CreateNodeSetApplyCallback()
{
  ...
  if(ugrid->GetPointData()->GetArray(nodeset))
  {
          ...
          KWMessageDialog->SetText("Node Set with the name already exists. Would you like to overwrite the existing Node Set?");
