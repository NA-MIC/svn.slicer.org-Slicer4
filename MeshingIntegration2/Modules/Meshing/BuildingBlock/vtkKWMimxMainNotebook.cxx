...
vtkCxxRevisionMacro(vtkKWMimxMainNotebook, "$Revision: 1.35 $");
...
vtkKWMimxMainNotebook::vtkKWMimxMainNotebook()
{
  ...
  strcpy(this->tabLabels[3], "Building Block");
  strcpy(this->tabLabels[4], "Mesh");
  strcpy(this->tabLabels[5], "Quality");
  strcpy(this->tabLabels[6], "Material Property");
  strcpy(this->tabLabels[7], "Boundary Conditions");
...
void vtkKWMimxMainNotebook::CreateWidget()
{
        ...
        vtkDebugMacro("about to create MainFrame in Notebook");
...
//    
//      vtkDebugMacro("MainFrame created; about to create notebook");
//    
...
//              this->Notebook->GetWidgetName());
        ...
        this->Notebook->AddPage("Building Block");
        this->Notebook->AddPage("Mesh");
        /* Add this page once Utilities exist*/
        this->Notebook->AddPage("Quality");
        this->Notebook->AddPage("Material Property");
        this->Notebook->AddPage("Boundary Conditions");
        this->Notebook->AddPage(">");
        this->Notebook->Raise();
...
//      tmpNote->HidePage("Material Property");
//      tmpNote->HidePage("Boundary Conditions");
...
//    tmpNote, vtkKWEvent::NotebookRaisePageEvent);
        ...
        this->BBMenuGroup->SetParent(this->Notebook->GetPageWidget("Building Block"));
...
//  this->FEMeshMenuGroup->SetMimxMainWindow(this->GetMimxMainWindow());
        ...
        this->MaterialPropertyMenuGroup->SetParent(this->Notebook->GetPageWidget("Material Property"));
        ...
        this->BoundaryConditionsMenuGroup->SetParent(this->Notebook->GetPageWidget("Boundary Conditions"));
