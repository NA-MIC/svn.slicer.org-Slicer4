...
vtkCxxRevisionMacro(vtkKWMimxReBinFEMeshMaterialPropertiesFromImageGroup, "$Revision: 1.10 $");
...
void vtkKWMimxReBinFEMeshMaterialPropertiesFromImageGroup::CreateWidget()
{
  ...
  this->MinimumValueFrame->SetParent(this->MainFrame->GetFrame());
  ...
  this->MaximumValueFrame->SetParent(this->MainFrame->GetFrame());
  ...
  this->NumOfBinsEntry->SetParent(this->MainFrame->GetFrame());
