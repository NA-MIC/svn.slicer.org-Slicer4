...
public:
  ...
  void ViewPropertyCallback(int row);
  void DisplayPropertyCallback();
  void CreateNameCellCallback(const char *tableWidgetName, int row, int col, const char *widgetName);
