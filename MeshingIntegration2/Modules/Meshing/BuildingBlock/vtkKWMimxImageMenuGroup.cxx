...
vtkCxxRevisionMacro(vtkKWMimxImageMenuGroup, "$Revision: 1.16 $");
...
vtkKWMimxImageMenuGroup::~vtkKWMimxImageMenuGroup()
{
  ...
  //  this->MimxImageViewProperties->Delete();
...
void vtkKWMimxImageMenuGroup::LoadImageCallback()
{
        ...
        if(this->FileBrowserDialog->GetStatus() == vtkKWDialog::StatusOK)
        {
                ...
                this->ImageList->GetItem(this->ImageList->GetNumberOfItems()-1)->SetFileName(
