...
vtkCxxRevisionMacro(vtkMimxMirrorUnstructuredHexahedronGridCell, "$Revision: 1.7 $");
...
// Initialize and check input
 ...
 // if yes use default values to mirror
  double planenor[3], center[3], x[3], xmod[3];
  this->MirrorPlane->GetNormal(planenor);
  this->MirrorPlane->GetOrigin(center);
