...
vtkCxxRevisionMacro(vtkMimxUnstructuredToStructuredGrid, "$Revision: 1.5 $");
  ...
  vtkInformationVector *outputVector)
{
        ...
        if(this->StructuredGridNum >= boundingbox->GetCellData()->GetArray("Mesh_Seed")->GetNumberOfTuples())
        {
