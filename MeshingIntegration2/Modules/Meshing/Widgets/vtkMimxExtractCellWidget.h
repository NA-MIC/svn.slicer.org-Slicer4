...
class vtkMimxExtractCellWidget : public vtk3DWidget
{
public:
  // Description:
 ...
 /* void SetOutlineCursorWires(int);
  ...
  vtkGetObjectMacro(PickedCellsCompleteGrid, vtkIdList);
protected:
...
//ETX
  ...
  vtkActor          *SelectedCellActor;
  vtkDataSetMapper  *SelectedCellMapper;
 ...
 /* vtkActor          *HexOutline;
  ...
  vtkIdList *PickedCellsCompleteGrid;
