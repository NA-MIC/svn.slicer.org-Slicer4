/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/branches/EndoTracking/Modules/EndoNavIF/vtkIGTLCircularBuffer.h $
...
class VTK_ENDONAV_EXPORT vtkIGTLCircularBuffer : public vtkObject
{
 public:
