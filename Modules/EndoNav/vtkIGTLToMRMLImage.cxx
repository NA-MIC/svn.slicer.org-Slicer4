/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/branches/EndoTracking/Modules/OpenIGTLinkIF/vtkIGTLToMRMLImage.cxx $
...
vtkCxxRevisionMacro(vtkIGTLToMRMLImage, "$Revision: 9377 $");
