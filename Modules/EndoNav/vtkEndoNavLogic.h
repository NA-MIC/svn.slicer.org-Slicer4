/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/branches/EndoTracking/Modules/EndoNav/vtkEndoNavLogic.h $
  Date:      $Date: 2009-01-05 13:28:20 -0500 (Mon, 05 Jan 2009) $
  Version:   $Revision: 8267 $

==========================================================================*/

// .NAME vtkEndoNavLogic - slicer logic class for Locator module 
// .SECTION Description
// This class manages the logic associated with tracking device for
// IGT. 


#ifndef __vtkEndoNavLogic_h
#define __vtkEndoNavLogic_h
...
class VTK_OPENIGTLINKIF_EXPORT vtkEndoNavLogic : public vtkSlicerModuleLogic 
{
 ...
 public:
  ...
  static vtkEndoNavLogic *New();
  
  vtkTypeRevisionMacro(vtkEndoNavLogic,vtkObject);
 ...
 protected:
  ...
  vtkEndoNavLogic();
  ~vtkEndoNavLogic();
  vtkEndoNavLogic(const vtkEndoNavLogic&);
  void operator=(const vtkEndoNavLogic&);
