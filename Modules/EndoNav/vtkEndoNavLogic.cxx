/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer3/branches/EndoTracking/Modules/EndoNav/vtkEndoNavLogic.cxx $
...
vtkCxxRevisionMacro(vtkEndoNavLogic, "$Revision: 9387 $");
vtkStandardNewMacro(vtkEndoNavLogic);

//---------------------------------------------------------------------------
vtkEndoNavLogic::vtkEndoNavLogic()
{
  // initialize slice driver information
  for (int i = 0; i < 3; i ++)
    {
    this->SliceDriver[i] = vtkEndoNavLogic::SLICE_DRIVER_USER;
  ...
  this->DataCallbackCommand->SetCallback(vtkEndoNavLogic::DataCallback);
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  this->vtkObject::PrintSelf(os, indent);

  os << indent << "vtkEndoNavLogic:             " << this->GetClassName() << "\n";

}


//---------------------------------------------------------------------------
int vtkEndoNavLogic::Initialize()
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::DataCallback(vtkObject *caller, 
                                       unsigned long eid, void *clientData, void *callData)
{
  vtkEndoNavLogic *self = reinterpret_cast<vtkEndoNavLogic *>(clientData);
  vtkDebugWithObjectMacro(self, "In vtkEndoNavLogic DataCallback");
  self->UpdateAll();
}


//---------------------------------------------------------------------------
void vtkEndoNavLogic::UpdateAll()
{
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::CheckConnectorsStatusUpdates()
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::AddConnector()
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::AddConnector(const char* name)
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::AddServerConnector(const char* name, int port)
{
  vtkIGTLConnector* connector = vtkIGTLConnector::New();
  this->LastConnectorID ++;
  int newID = this->LastConnectorID;
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::AddClientConnector(const char* name, const char* svrHostName, int port)
{
  vtkIGTLConnector* connector = vtkIGTLConnector::New();
  this->LastConnectorID ++;
  int newID = this->LastConnectorID;
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::DeleteConnector(int id)
{
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::GetNumberOfConnectors()
{
  return this->ConnectorMap.size();
}

//---------------------------------------------------------------------------
vtkIGTLConnector* vtkEndoNavLogic::GetConnector(int id)
{
  ConnectorMapType::iterator iter = this->ConnectorMap.find(id);
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::GetConnectorID(vtkIGTLConnector* con)
{
...
//---------------------------------------------------------------------------
vtkEndoNavLogic::ConnectorMapType* vtkEndoNavLogic::GetConnectorMap()
{
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::RegisterDeviceEvent(vtkIGTLConnector* con, const char* deviceName, const char* deviceType)
{
  if (con == NULL)
    {
    return 0;
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::UnregisterDeviceEvent(vtkIGTLConnector* con, const char* deviceName, const char* deviceType)
{
  if (con == NULL)
    {
    return 0;
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::ImportFromCircularBuffers()
{
  ConnectorMapType::iterator cmiter;
  ...
  for (cmiter = this->ConnectorMap.begin(); cmiter != this->ConnectorMap.end(); cmiter ++)
    ...
    for (nameIter = nameList.begin(); nameIter != nameList.end(); nameIter ++)
      {
      //vtkErrorMacro("vtkEndoNavLogic::ImportFromCircularBuffers(): Import Image from : " << *nameIter);
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::SetLocatorDriver(const char* nodeID)
{
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::EnableLocatorDriver(int sw)
{
  if (sw == 1)  // turn on
    {
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::SetRealTimeImageSource(const char* nodeID)
{
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::SetSliceDriver(int index, int v)
{
  if (index < 0 || index >= 3)
    {
    return 0;
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::GetSliceDriver(int index)
{
  if (index < 0 || index >= 3)
    {
    return -1;
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::SetRestrictDeviceName(int f)
{
...
//---------------------------------------------------------------------------
int  vtkEndoNavLogic::AddDeviceToConnector(int conID, const char* deviceName, const char* deviceType, int io)
...
//---------------------------------------------------------------------------
int  vtkEndoNavLogic::DeleteDeviceFromConnector(int conID, const char* deviceName, const char* deviceType, int io)
{
  vtkIGTLConnector* connector = GetConnector(conID);
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::DeleteDeviceFromConnector(int conID, int devID, int io)
{
  vtkIGTLConnector* connector = GetConnector(conID);
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::RegisterMessageConverter(vtkIGTLToMRMLBase* converter)
{
  if (converter == NULL)
    {
    return 0;
...
//---------------------------------------------------------------------------
int vtkEndoNavLogic::UnregisterMessageConverter(vtkIGTLToMRMLBase* converter)
{
  if (converter == NULL)
    {
    return 0;
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::ProcessMRMLEvents(vtkObject * caller, unsigned long event, void * callData)
{
  if (caller != NULL)
    {
...
//---------------------------------------------------------------------------
vtkIGTLToMRMLBase* vtkEndoNavLogic::GetConverterByDeviceType(const char* deviceType)
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::UpdateSliceNode(int sliceNodeNumber, vtkMatrix4x4* transform)
{
  ...
  // The EndoNav module saves the slice orientations in SliceOrientation[]
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::UpdateSliceNodeByImage(int sliceNodeNumber)
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::CheckSliceNode()
{
...
//---------------------------------------------------------------------------
vtkMRMLModelNode* vtkEndoNavLogic::SetVisibilityOfLocatorModel(const char* nodeName, int v)
{
...
//---------------------------------------------------------------------------
vtkMRMLModelNode* vtkEndoNavLogic::AddLocatorModel(const char* nodeName, double r, double g, double b)
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::ProcCommand(const char* nodeName, int size, unsigned char* data)
{
}

//---------------------------------------------------------------------------
void vtkEndoNavLogic::GetDeviceNamesFromMrml(IGTLMrmlNodeListType &list)
{
...
//---------------------------------------------------------------------------
void vtkEndoNavLogic::GetDeviceNamesFromMrml(IGTLMrmlNodeListType &list, const char* mrmlTagName)
{
