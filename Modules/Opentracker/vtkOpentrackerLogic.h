...
// .NAME vtkOpentrackerLogic - slicer logic class for Locator module 
// .SECTION Description
// This class manages the logic associated with tracking device for
// IGT. 


#ifndef __vtkOpentrackerLogic_h
#define __vtkOpentrackerLogic_h
...
public:
    ...
    static vtkOpentrackerLogic *New();
    vtkTypeRevisionMacro(vtkOpentrackerLogic,vtkObject);
...
protected:
    ...
    vtkOpentrackerLogic();
    ~vtkOpentrackerLogic();
    vtkOpentrackerLogic(const vtkOpentrackerLogic&);
    void operator=(const vtkOpentrackerLogic&);
