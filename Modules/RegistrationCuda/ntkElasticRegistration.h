#ifndef NTKELASTICREGISTRATION_H
#define NTKELASTICREGISTRATION_H
...
class ntkElasticRegistration : public ntkRegistration{
  typedef struct{
    ntkElasticRegistration* here;
    int threadNumber;
    ntk3DData* target;
    int splineSizeLevel;
