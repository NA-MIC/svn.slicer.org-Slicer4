...
void vtkNeuroNavGUI::RemoveGUIObservers ( )
{
    ...
    appGUI->GetMainSliceGUI("Green")->GetSliceViewer()->GetRenderWidget()->GetRenderWindowInteractor()->GetInteractorStyle()->RemoveObserver((vtkCommand *)this->GUICallbackCommand);
...
void vtkNeuroNavGUI::AddGUIObservers ( )
{
    ...
    appGUI->GetMainSliceGUI("Green")->GetSliceViewer()->GetRenderWidget()->GetRenderWindowInteractor()->GetInteractorStyle()->AddObserver(vtkCommand::LeftButtonPressEvent, (vtkCommand *)this->GUICallbackCommand);
...
void vtkNeuroNavGUI::HandleMouseEvent(vtkSlicerInteractorStyle *style)
{
    ...
    vtkSlicerInteractorStyle *istyle2 = vtkSlicerInteractorStyle::SafeDownCast(appGUI->GetMainSliceGUI("Green")->GetSliceViewer()->GetRenderWidget()->GetRenderWindowInteractor()->GetInteractorStyle());
...
void vtkNeuroNavGUI::Enter ( )
{
    ...
    this->Logic2 = appGUI->GetMainSliceGUI("Green")->GetLogic();
    ...
    this->Control2 = appGUI->GetMainSliceGUI("Green")->GetSliceController();
