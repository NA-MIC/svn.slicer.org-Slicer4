...
{
    if (this->UltrasoundStreamerGUI != NULL)
        this->UltrasoundStreamerGUI->ProcessGUIEvents(caller, event, callData);
}
...
{
    if (this->UltrasoundStreamerGUI->IsEnabled())
    {
        this->UltrasoundStreamerGUI->UpdateInput();
        this->VolumeNode->Modified();

        std::stringstream str;
        str << "after " << (int) (1000.0 / this->UltrasoundStreamerGUI->GetRefreshRate()) << " %s UpdateInput";
