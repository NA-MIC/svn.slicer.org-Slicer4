...
// .NAME vtkNeurosurgeryLogic - slicer logic class for Locator module 
// .SECTION Description
// This class manages the logic associated with tracking device for
// IGT. 


#ifndef __vtkNeurosurgeryLogic_h
#define __vtkNeurosurgeryLogic_h
...
class VTK_NEUROSURGERY_EXPORT vtkNeurosurgeryLogic : public vtkSlicerLogic 
{
public:

    // The Usual vtk class functions
    static vtkNeurosurgeryLogic *New();
    vtkTypeRevisionMacro(vtkNeurosurgeryLogic,vtkObject);
...
protected:
    ...
    vtkNeurosurgeryLogic();
    ~vtkNeurosurgeryLogic();
    vtkNeurosurgeryLogic(const vtkNeurosurgeryLogic&);
    void operator=(const vtkNeurosurgeryLogic&);
