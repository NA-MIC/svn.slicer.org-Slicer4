...
public:
  ...
  void SetBeta(double beta){ this->m_VesselnessFilter->SetBeta(beta); }
  double GetBeta(){ return( this->m_VesselnessFilter->GetBeta() ); }

  void SetGamma(double gamma){ this->m_VesselnessFilter->SetGamma(gamma); }
  double GetGamma(){ return(this->m_VesselnessFilter->GetGamma() ); }

  void SetC(double c){ this->m_VesselnessFilter->SetC(c); }
  double GetC(){ return(this->m_VesselnessFilter->GetC() ); }

  void SetScaleVesselnessMeasure(bool vm){ this->m_VesselnessFilter->SetScaleVesselnessMeasure(vm); }
  bool GetScaleVesselnessMeasure(){ return(this->m_VesselnessFilter->GetScaleVesselnessMeasure() ); }
