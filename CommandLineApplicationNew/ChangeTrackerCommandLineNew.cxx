...
//    if(tgThreshold[0] == 0){
    ...
    tgWriteVolume("scan1_segmentation_thresh.nrrd",supersampleMatrix,Scan1Segment->GetOutput());
    ...
    CMD = tg.WorkingDir + "/TG_Analysis_Intensity_Diff.nhdr";
    tgWriteVolume(CMD.c_str(),supersampleMatrix,logic->GetAnalysis_Intensity_ScanSubtractSmooth());
    CMD = tg.WorkingDir + "/ROI_Growth_mask.nrrd";
