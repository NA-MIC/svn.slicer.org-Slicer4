...
void vtkSlicerFiducialsGUI::RemoveGUIObservers ( )
{
    ...
    this->FiducialsListLockToggle->RemoveObservers ( vtkKWMenu::MenuItemInvokedEvent, (vtkCommand *)this->GUICallbackCommand );    
...
/*
              ...
              // wjp: I thought individual fids could be visible and the list could still be hidden???
