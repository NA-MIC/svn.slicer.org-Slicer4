...
Module:    $RCSfile: vtkMimxMeshQualityRendering.h,v $
Language:  C++
...
// .NAME vtkMimxMeshQualityRendering -
// .SECTION Description
//

#ifndef __vtkMimxMeshQualityRendering_h
#define __vtkMimxMeshQualityRendering_h
...
//
class  VTK_HYBRID_EXPORT vtkMimxMeshQualityRendering : public vtkObject {
...
private:
  ...
  // keep state variables here for creating poly data from each rendering mode of the mesh
  vtkPolyData* SavedMeshPolyDataForRendering;
  vtkPolyData* SavedOutlinePolyDataForRendering;
  vtkPolyData* SavedHedgehogPolyDataForRendering;
...
public:
  static vtkMimxMeshQualityRendering* New();
  vtkMimxMeshQualityRendering();
  ~vtkMimxMeshQualityRendering();
  vtkTypeRevisionMacro(vtkMimxMeshQualityRendering,vtkMimxMeshQualityRendering);
  ...
  vtkPolyData*  GetMeshPolygons(void);
  vtkPolyData*  GetOutlinePolygons(void);
  vtkPolyData*  GetHedgehogPolygons(void);
