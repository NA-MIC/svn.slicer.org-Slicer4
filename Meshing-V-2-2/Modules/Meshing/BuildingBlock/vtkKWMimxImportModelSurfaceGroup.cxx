...
{
               // if(vtkKWComboBoxWithLabel->GetSelection())
    ...
    //{
        ...
        vtkMRMLScene* scene = vtkMRMLScene::GetActiveScene();
        vtkPolyData* modelPolys = vtkMRMLModelNode::SafeDownCast(scene->GetNodeByID(name))->GetDisplayNode()->GetPolyData();
        this->AddSurfaceToDisplay(modelPolys, "", name );
        this->UpdateObjectLists();
        this->GetMimxMainWindow()->SetStatusText("Imported a MRML Model for meshing");
    //}
    //else
     //  this->GetMimxMainWindow()->SetStatusText("Failed to load because of NULL Surface List");
