...
namespace itk
{
template<class TInputMesh> class ITK_EXPORT ItkMeshToFEMMesh : public LightProcessObject
  {
  ...
  public:
    ...
    typedef typename MeshType::Pointer                        MeshTypePointer;    typedef typename MeshType::CellType                       CellType;    typedef typename MeshType::PointType                      PointType;    typedef typename MeshType::CellPixelType                  CellPixelType;    typedef typename MeshType::CellsContainerPointer          CellsContainerPointer;    typedef typename MeshType::CellsContainer::ConstIterator  CellIterator;    typedef typename itk::VertexCell< CellType >              VertexType;    typedef typename itk::HexahedronCell< CellType >          HexahedronType;    typedef typename HexahedronType::PointIdIterator          PointIdIterator;
