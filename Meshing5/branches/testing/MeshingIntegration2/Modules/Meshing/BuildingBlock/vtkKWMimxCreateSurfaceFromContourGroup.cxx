...
vtkCxxRevisionMacro(vtkKWMimxCreateSurfaceFromContourGroup, "$Revision: 1.21 $");
...
void vtkKWMimxCreateSurfaceFromContourGroup::CreateWidget()
{
  ...
  this->InteractionFrame->SetParent(this->MainFrame->GetFrame());
...
/*
  ...
  this->DoneButton->SetCommand(this, "CreateSurfaceFromContourDoneCallback");
  this->GetApplication()->Script(
