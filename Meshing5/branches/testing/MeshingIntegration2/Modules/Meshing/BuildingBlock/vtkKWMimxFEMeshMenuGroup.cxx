...
vtkCxxRevisionMacro(vtkKWMimxFEMeshMenuGroup, "$Revision: 1.55 $");
...
/*  this->ObjectMenuButton->GetWidget()->GetMenu()->AddRadioButton(
    ...
    "Assign/Edit",this, "EditFEMeshCallback");
  this->OperationMenuButton->GetWidget()->GetMenu()->AddRadioButton(
...
void vtkKWMimxFEMeshMenuGroup::EditElementNumbersCallback()
{
        if(!this->EditElementSetNumbersGroup)
        {
                ...
                this->EditElementSetNumbersGroup->SetParent(this->MainFrame->GetFrame());
...
void vtkKWMimxFEMeshMenuGroup::EditNodeNumbersCallback()
{
        if(!this->EditNodeSetNumbersGroup)
        {
                ...
                this->EditNodeSetNumbersGroup->SetParent(this->MainFrame->GetFrame());
