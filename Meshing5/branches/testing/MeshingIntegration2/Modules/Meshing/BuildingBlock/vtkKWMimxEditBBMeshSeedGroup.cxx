...
vtkCxxRevisionMacro(vtkKWMimxEditBBMeshSeedGroup, "$Revision: 1.27 $");
...
void vtkKWMimxEditBBMeshSeedGroup::CreateWidget()
{
 ...
 // for selecting the building-block structure
  ...
  this->EditTypeSelection->SetParent(this->MainFrame->GetFrame());
...
/*
  this->MeshSeedTypeFrame->SetParent(this->MainFrame->GetFrame());
...
/*
  ...
  this->CellSelectionFrame->SetParent(this->MainFrame->GetFrame());
...
//        this->ElementLengthCheckButton->GetWidgetName());
  ...
  this->EditTypeChoiceFrame->SetParent(this->MainFrame->GetFrame());
  ...
  this->XMeshSeed->GetWidget()->SetValueAsDouble(1.0);
  this->YMeshSeed->GetWidget()->SetValueAsDouble(1.0);
  this->ZMeshSeed->GetWidget()->SetValueAsDouble(1.0);
...
*/
  ...
  this->GetApplication()->Script(
          "pack %s -side left -anchor nw -expand n -padx 15 -pady 2", 
...
/*
  ...
  this->GetApplication()->Script(
    "pack %s -side left -anchor nw -expand n -padx 8 -pady 6", 
...
*/
  ...
  this->GetApplication()->Script(
    "pack %s -side right -anchor ne -expand n -padx 15 -pady 2", 
  ...
  this->ShowMeshSeedCheckButton->SetParent(this->MainFrame->GetFrame());
