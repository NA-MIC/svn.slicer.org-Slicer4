/*=========================================================================
  ...
  Module:    $RCSfile: vtkFiniteElementMRMLMeshMenuGroup.cxx,v $coyright (c) Kitware, Inc.
  All rights reserved.
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkFiniteElementMRMLMeshMenuGroup);
vtkCxxRevisionMacro(vtkFiniteElementMRMLMeshMenuGroup, "$Revision: 1.9 $");


//vtkFiniteElementMRMLMeshMenuGroup* vtkFiniteElementMRMLMeshMenuGroup::New()
//{
//  // First try to create the object from the vtkObjectFactory
//  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkFiniteElementMRMLMeshMenuGroup");
//  if(ret)
//    {
//      return (vtkFiniteElementMRMLMeshMenuGroup*)ret;
//    }
//  // If the factory was unable to create the object, then create it here.
//  return new vtkFiniteElementMRMLMeshMenuGroup;
//}



//----------------------------------------------------------------------------
vtkFiniteElementMRMLMeshMenuGroup::vtkFiniteElementMRMLMeshMenuGroup()
{
 cout << "vtkFiniteElementMRMLMeshMenuGroup constructor" << endl;
...
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::Update()
{
  this->UpdateEnableState();
}
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::UpdateEnableState()
{
  this->Superclass::UpdateEnableState();
}
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::BBMenuCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::LoadBBCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::CreateBBCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::LoadVTKBBCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}
//---------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::CreateBBFromBoundsCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::BBMeshSeedMenuCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::FEMeshMenuCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::CreateBBMeshSeedCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::EditBBMeshSeedCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::HideAllDialogBoxes()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::CreateFEMeshCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::CreateFEMeshFromBBCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::SaveBBCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::SaveVTKBBCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::EditFEMeshCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::LoadFEMeshCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::SaveFEMeshCallback()
{
...
//-----------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::LoadVTKFEMeshCallback()
{
...
//---------------------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::DeleteBBCallback()
{
...
//---------------------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::DeleteFEMeshCallback()
{
...
//---------------------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::SaveVTKFEMeshCallback()
{
...
//------------------------------------------------------------------------------------------
void vtkFiniteElementMRMLMeshMenuGroup::SmoothLaplacianFEMeshCallback()
{
