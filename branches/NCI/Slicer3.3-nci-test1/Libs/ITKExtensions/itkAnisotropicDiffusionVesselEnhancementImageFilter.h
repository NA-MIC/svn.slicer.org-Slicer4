...
public:
  ...
  /** More Set/Get for MultiScaleVesselness */
  void SetAlpha(double alpha){ this->m_MultiScaleVesselnessFilter->SetAlpha(alpha); }
  double GetAlpha(){ return( this->m_MultiScaleVesselnessFilter->GetAlpha() );}

  void SetBeta(double beta){ this->m_MultiScaleVesselnessFilter->SetBeta(beta); }
  double GetBeta(){ return( this->m_MultiScaleVesselnessFilter->GetBeta() ); }

  void SetGamma(double gamma){ this->m_MultiScaleVesselnessFilter->SetGamma(gamma); }
  double GetGamma(){ return(this->m_MultiScaleVesselnessFilter->GetGamma() ); }

  void SetC(double c){ this->m_MultiScaleVesselnessFilter->SetC(c); }
  double GetC(){ return(this->m_MultiScaleVesselnessFilter->GetC() ); }

  void SetScaleVesselnessMeasure(bool vm){ this->m_MultiScaleVesselnessFilter->SetScaleVesselnessMeasure(vm); }
  bool GetScaleVesselnessMeasure(){ return(this->m_MultiScaleVesselnessFilter->GetScaleVesselnessMeasure() ); }
