...
//---------------------------------------------------------------------------
vtkStandardNewMacro (vtkNeurosurgeryGUI );
vtkCxxRevisionMacro ( vtkNeurosurgeryGUI, "$Revision: 1.0 $");


//---------------------------------------------------------------------------
vtkNeurosurgeryGUI::vtkNeurosurgeryGUI ( )
{
    this->Logic = NULL;
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::PrintSelf ( ostream& os, vtkIndent indent )
{
    this->vtkObject::PrintSelf ( os, indent );

    os << indent << "NeurosurgeryGUI: " << this->GetClassName ( ) << "\n";
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::RemoveGUIObservers ( )
{
    // Fill in
    if (this->LoadConfigButton)
    {
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::AddGUIObservers ( )
{
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::ProcessGUIEvents ( vtkObject *caller,
        unsigned long event, void *callData )
{
    ...
    {
        vtkNeurosurgeryLogic *igtLogic = this->Logic;
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::ProcessLogicEvents ( vtkObject *caller,
        unsigned long event, void *callData )
{
    // Fill in
}
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::ProcessMRMLEvents ( vtkObject *caller,
        unsigned long event, void *callData )
{
    // Fill in
}
...
void vtkNeurosurgeryGUI::MakeLocator()
{
...
void vtkNeurosurgeryGUI::UpdateSliceDisplay(float px, float py, float pz)
{
...
void vtkNeurosurgeryGUI::UpdateLocator()
{
    vtkNeurosurgeryLogic *igtLogic = this->Logic;
...
//---------------------------------------------------------------------------
void vtkNeurosurgeryGUI::BuildGUI ( )
{

    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    // Define your help text here.
    const char *help = "The **Neurosurgery Module** connects Slicer to a SPLOT server that feeds a real-time stream of coordinates from a tracking device. This is useful in the operating room to allow the surgeons to navigate the preloaded volume(s) by pointing to a location with a probe that is tracked."; 

    // ---
    // MODULE GUI FRAME 
    // create a page
    this->UIPanel->AddPage ( "Neurosurgery", "Neurosurgery", NULL );

    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "Neurosurgery" );


    // ----------------------------------------------------------------
    // HELP FRAME            
    // ----------------------------------------------------------------
    vtkSlicerModuleCollapsibleFrame *NeurosurgeryHelpFrame = vtkSlicerModuleCollapsibleFrame::New ( );
    NeurosurgeryHelpFrame->SetParent ( page );
    NeurosurgeryHelpFrame->Create ( );
    NeurosurgeryHelpFrame->CollapseFrame ( );
    NeurosurgeryHelpFrame->SetLabelText ("Help");
    app->Script ( "pack %s -side top -anchor nw -fill x -padx 2 -pady 2 -in %s",
            NeurosurgeryHelpFrame->GetWidgetName(), page->GetWidgetName());

    // configure the parent classes help text widget
    this->HelpText->SetParent ( NeurosurgeryHelpFrame->GetFrame() );
...
void vtkNeurosurgeryGUI::BuildGUIForRegistrationFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "Neurosurgery" );
...
void vtkNeurosurgeryGUI::BuildGUIForServerFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "Neurosurgery" );
...
void vtkNeurosurgeryGUI::BuildGUIForTrackingFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "Neurosurgery" );
...
void vtkNeurosurgeryGUI::BuildGUIForHandPieceFrame ()
{
    vtkSlicerApplication *app = (vtkSlicerApplication *)this->GetApplication();
    vtkKWWidget *page = this->UIPanel->GetPageWidget ( "Neurosurgery" );
