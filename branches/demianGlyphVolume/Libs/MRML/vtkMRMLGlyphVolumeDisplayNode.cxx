...
Program:   3D Slicer
Module:    $RCSfile: vtkMRMLGlyphVolumeDisplayNode.cxx,v $
...
/*
//------------------------------------------------------------------------------
vtkMRMLGlyphVolumeDisplayNode* vtkMRMLGlyphVolumeDisplayNode::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLGlyphVolumeDisplayNode");
  if(ret)
    {
    return (vtkMRMLGlyphVolumeDisplayNode*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkMRMLGlyphVolumeDisplayNode;
}

//----------------------------------------------------------------------------

vtkMRMLNode* vtkMRMLGlyphVolumeDisplayNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLGlyphVolumeDisplayNode");
  if(ret)
...
//----------------------------------------------------------------------------
vtkMRMLGlyphVolumeDisplayNode::vtkMRMLGlyphVolumeDisplayNode()
{
  // Strings
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::SetDefaultColorMap(int isLabelMap)
 {
  ...
  if (this->GlyphColorNode == NULL)
    {
    vtkDebugMacro("vtkMRMLGlyphVolumeDisplayNode: FAILED setting default  color node, it's still null\n")
    }
  else
    {
    vtkDebugMacro("vtkMRMLGlyphVolumeDisplayNode: set up the default color node\n");
    }
}
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::UpdateReferenceID(const char *oldID, const char *newID)
{
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::ReadXMLAttributes(const char** atts)
{
...
void vtkMRMLGlyphVolumeDisplayNode::Copy(vtkMRMLNode *anode)
{
  Superclass::Copy(anode);
  vtkMRMLGlyphVolumeDisplayNode *node = (vtkMRMLGlyphVolumeDisplayNode *) anode;
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//-----------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::UpdateScene(vtkMRMLScene *scene)
{
...
//-----------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::UpdateReferences()
{
...
//-----------------------------------------------------------
vtkPolyData* vtkMRMLGlyphVolumeDisplayNode::ExecuteGlyphPipeLineAndGetPolyData( vtkImageData* )
{
  return NULL;
}
//----------------------------------------------------------------------------
vtkMRMLColorNode* vtkMRMLGlyphVolumeDisplayNode::GetGlyphColorNode()
{
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::SetAndObserveGlyphColorNodeID(std::string glyphColorNodeID)
{
...
//----------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::SetAndObserveGlyphColorNodeID(const char *glyphColorNodeID)
{
  vtkSetAndObserveMRMLObjectMacro(this->GlyphColorNode, NULL);
...
//---------------------------------------------------------------------------
void vtkMRMLGlyphVolumeDisplayNode::ProcessMRMLEvents ( vtkObject *caller,
                                           unsigned long event, 
                                           void *callData )
{
