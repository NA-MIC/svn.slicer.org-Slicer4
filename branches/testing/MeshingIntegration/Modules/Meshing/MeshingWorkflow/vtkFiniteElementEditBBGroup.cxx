/*=========================================================================
  ...
  Module:    $RCSfile: vtkFiniteElementEditBBGroup.cxx,v $
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkFiniteElementEditBBGroup);
vtkCxxRevisionMacro(vtkFiniteElementEditBBGroup, "$Revision: 1.8 $");

//----------------------------------------------------------------------------
vtkFiniteElementEditBBGroup::vtkFiniteElementEditBBGroup()
{
  //this->MainFrame = NULL;
...
//--------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::SelectionChangedCallback(const char* dummy)
{
...
//--------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::CreateWidget()
{
  if(this->IsCreated())
  {
...
//----------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::Update()
{
  this->UpdateEnableState();
}
//---------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::UpdateEnableState()
{
  this->Superclass::UpdateEnableState();
}
//----------------------------------------------------------------------------
// *** changed method to use MRML lists
void vtkFiniteElementEditBBGroup::EditBBDoneCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}
//----------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::EditBBCancelCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::EditBBDeleteCellCallback()
{
...
//----------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::EditBBSplitCellCallback()
{
  if(strcmp(this->ObjectListComboBox->GetWidget()->GetValue(),""))
  {
...
//----------------------------------------------------------------------------
void vtkFiniteElementEditBBGroup::EditBBAddCellCallback()
{
  if(strcmp(this->ObjectListComboBox->GetWidget()->GetValue(),""))
  {
...
void vtkFiniteElementEditBBGroup::EditBBMoveCellCallback()
{
    ...
    if(strcmp(this->ObjectListComboBox->GetWidget()->GetValue(),""))
    {
      if(this->MoveButtonState)
      {
        ...
        this->UnstructuredGridWidget->SetInteractor(this->GetMimxViewWindow()->GetRenderWidget()->GetRenderWindowInteractor());
...
void vtkFiniteElementEditBBGroup::EditBBVtkInteractionCallback()
{
  if(this->UnstructuredGridWidget)
  {
    if (this->UnstructuredGridWidget->GetEnabled())
