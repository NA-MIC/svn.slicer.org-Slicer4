...
set ::SLICER_TAG "http://www.na-mic.org/svn/Slicer3/branches/testing/newLibs-2008-05-tk85"
...
switch $::tcl_platform(os) {
    ...
    "Darwin" {
        ...
        set ::ITCL_TEST_FILE $::TCL_LIB_DIR/libitcl3.4.dylib
    ...
    "Linux" {
        ...
        set ::TCL_TEST_FILE $::TCL_BIN_DIR/tclsh8.5
        set ::TK_TEST_FILE  $::TCL_BIN_DIR/wish8.5
        set ::ITCL_TEST_FILE $::TCL_LIB_DIR/libitcl3.4.so
        set ::TEEM_TEST_FILE $::TEEM_BIN_DIR/unu
        set ::VTK_TEST_FILE $::VTK_DIR/bin/vtk
