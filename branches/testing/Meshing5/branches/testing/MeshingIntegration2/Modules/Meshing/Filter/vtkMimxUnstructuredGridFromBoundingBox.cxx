...
vtkCxxRevisionMacro(vtkMimxUnstructuredGridFromBoundingBox, "$Revision: 1.11 $");
...
//  bboxtosgrid->SetMeshSeed(vtkIntArray::SafeDownCast(bbox->GetCellData()->GetArray("Mesh_Seed")));
  ...
  //***************************************************************************************
    ...
    globallocator->InitPointInsertion(globalpoints, bboxtosgrid->GetOutput()->GetBounds());
