...
vtkCxxRevisionMacro(vtkKWMimxCreateFEMeshElementSetGroup, "$Revision: 1.16 $");
...
void vtkKWMimxCreateFEMeshElementSetGroup::CreateWidget()
{
  ...
  this->AcceptSelectionButtonSet->SetParent(this->MainFrame->GetFrame());
...
//---------------------------------------------------------------------------------
void vtkKWMimxCreateFEMeshElementSetGroup::AcceptSelectionCallback()
{
        if(!SelectionState)     return;
        if(this->SelectCellsWidget)
        {
                this->SelectCellsWidget->AcceptSelectedMesh(this->SelectCellsWidget);
                this->SelectSubsetRadiobuttonSet->GetWidget(3)->SetEnabled(0);
        }
}
//---------------------------------------------------------------------------------
