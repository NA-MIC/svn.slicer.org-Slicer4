...
vtkCxxRevisionMacro(vtkKWMimxEditNodeSetNumbersGroup, "$Revision: 1.1 $");
...
void vtkKWMimxEditNodeSetNumbersGroup::CreateWidget()
{
  ...
  this->MainFrame->SetLabelText("Edit Node Numbers of a given Node set");
  ...
  NodeSetComboBox->SetParent(this->MainFrame->GetFrame());
  NodeSetComboBox->Create();
  NodeSetComboBox->SetLabelText("Node Set : ");
  NodeSetComboBox->SetLabelWidth(15);
  ...
  this->StartingNodeNumberEntry->SetParent(this->MainFrame->GetFrame());
  this->StartingNodeNumberEntry->Create();
  //this->StartingNodeNumberEntry->SetWidth(10);
  this->StartingNodeNumberEntry->SetLabelWidth(15);
  this->StartingNodeNumberEntry->SetLabelText("Start Node Num : ");
...
/*
  ...
  this->DoneButton->SetCommand(this, "EditNodeSetNumbersDoneCallback");
  this->GetApplication()->Script(
    "pack %s -side left -anchor nw -expand y -padx 20 -pady 6", 
