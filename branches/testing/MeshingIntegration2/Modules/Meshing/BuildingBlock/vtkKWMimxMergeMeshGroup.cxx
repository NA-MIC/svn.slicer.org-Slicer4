...
vtkCxxRevisionMacro(vtkKWMimxMergeMeshGroup, "$Revision: 1.19 $");
...
void vtkKWMimxMergeMeshGroup::CreateWidget()
{
  ...
  this->NodeMergingFrame->SetParent(this->MainFrame->GetFrame());
...
/*
  ...
  this->DoneButton->SetCommand(this, "MergeMeshDoneCallback");
  this->GetApplication()->Script(
    "pack %s -side left -anchor nw -expand y -padx 20 -pady 6", 
