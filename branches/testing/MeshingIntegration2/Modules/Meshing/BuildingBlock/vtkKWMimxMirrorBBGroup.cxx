...
vtkCxxRevisionMacro(vtkKWMimxMirrorBBGroup, "$Revision: 1.15 $");
...
void vtkKWMimxMirrorBBGroup::CreateWidget()
{
  ...
  this->TypeOfMirroring->SetParent(this->MainFrame->GetFrame());
  ...
  this->AxisSelection->SetParent(this->MainFrame->GetFrame());
...
/*
  ...
  this->DoneButton->SetCommand(this, "MirrorBBDoneCallback");
  this->GetApplication()->Script(
        ...
        callback->SetState(0);
                ...
                if(this->MirrorPlaneWidget)
                {
                        ...
                        if (!callback->GetState())
                        {
                                ...
                                this->EditBBGroup->AddEditedBB(num, mirror->GetOutput(), "Mirror_", this->Count);
...
//--------------------------------------------------------------------------------
void vtkKWMimxMirrorBBGroup::MirrorBBDoneCallback()
{
        if(this->MirrorBBApplyCallback())
                this->MirrorBBCancelCallback();
}
//---------------------------------------------------------------------------------
