...
vtkCxxRevisionMacro(vtkKWMimxDisplayPropertiesGroup, "$Revision: 1.11 $");
...
void vtkKWMimxDisplayPropertiesGroup::CreateWidget()
{
  ...
  this->TextColorButton->SetColor(1.0, 1.0, 1.0);
...
{
        //this->BackGroundColorButton->ButtonPressCallback();
        //this->BackGroundColorButton->ButtonReleaseCallback();
