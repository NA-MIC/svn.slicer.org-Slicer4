...
Program:   3D Slicer
Module:    $RCSfile: vtkMRMLStereoOptimizerNode.cxx,v $
...
//------------------------------------------------------------------------------
vtkMRMLStereoOptimizerNode* vtkMRMLStereoOptimizerNode::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLStereoOptimizerNode");
  if(ret)
    {
      return (vtkMRMLStereoOptimizerNode*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkMRMLStereoOptimizerNode;
}

//----------------------------------------------------------------------------

vtkMRMLNode* vtkMRMLStereoOptimizerNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLStereoOptimizerNode");
  if(ret)
...
//----------------------------------------------------------------------------
vtkMRMLStereoOptimizerNode::vtkMRMLStereoOptimizerNode()
{
...
//----------------------------------------------------------------------------
void vtkMRMLStereoOptimizerNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLStereoOptimizerNode::ReadXMLAttributes(const char** atts)
{
...
void vtkMRMLStereoOptimizerNode::Copy(vtkMRMLNode *anode)
{
  Superclass::Copy(anode);
  vtkMRMLStereoOptimizerNode *node = (vtkMRMLStereoOptimizerNode *) anode;
...
//----------------------------------------------------------------------------
void vtkMRMLStereoOptimizerNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLStereoOptimizerNode::UpdateReferenceID(const char *oldID, const char *newID)
{
...
//----------------------------------------------------------------------------
void vtkMRMLStereoOptimizerNode::SaveResultToTextFile( const char *fileName )
{
  std::ofstream myfile;
