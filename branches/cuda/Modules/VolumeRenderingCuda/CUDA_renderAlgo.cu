                                                    ...
                                                    uchar4* d_resultImage)
{
 ...
 __shared__ float s_rotationMatrix1[4]; //1st row of rotation matrix
 __shared__ float s_rotationMatrix2[4]; //2nd row of rotation matrix
 __shared__ float s_rotationMatrix3[4]; //3rd row of rotation matrix
 ...
 s_lensMap[tempacc*4]=0;
 s_lensMap[tempacc*4+1]=0;
 s_lensMap[tempacc*4+2]=(xIndex-s_dsize[0]*0.5)/s_dsize[0]*4.0;
 s_lensMap[tempacc*4+3]=(yIndex-s_dsize[1]*0.5)/s_dsize[0]*4.0;
 ...
 __syncthreads();
 /*
 //lens map for parallel projection

 s_lensMap[tempacc*4]=(xIndex-s_dsize[0]*0.5)/2.0;
 s_lensMap[tempacc*4+1]=(yIndex-s_dsize[1]*0.5)/2.0;
 s_lensMap[tempacc*4+2]=0;
 s_lensMap[tempacc*4+3]=0;
 */

 //apply translation and rotation transformation to rays

 s_rayMap[tempacc*6+3] = (s_lensMap[tempacc*4+2]*s_rotationMatrix1[0] + s_lensMap[tempacc*4+3]*s_rotationMatrix1[1] + s_rotationMatrix1[2])*s_vsize[0];
 s_rayMap[tempacc*6+4] = (s_lensMap[tempacc*4+2]*s_rotationMatrix2[0] + s_lensMap[tempacc*4+3]*s_rotationMatrix2[1] + s_rotationMatrix2[2])*s_vsize[1];
 s_rayMap[tempacc*6+5] = (s_lensMap[tempacc*4+2]*s_rotationMatrix3[0] + s_lensMap[tempacc*4+3]*s_rotationMatrix3[1] + s_rotationMatrix3[2])*s_vsize[2];

 s_rayMap[tempacc*6] = ((float)s_size[0]/2.0f + ((s_lensMap[tempacc*4]+s_rotationMatrix1[3])*s_rotationMatrix1[0] + (s_lensMap[tempacc*4+1]+s_rotationMatrix2[3])*s_rotationMatrix1[1] + (s_disp[2])*s_rotationMatrix1[2])*s_vsize[0]);
 s_rayMap[tempacc*6+1] = ((float)s_size[1]/2.0f + ((s_lensMap[tempacc*4]+s_rotationMatrix1[3])*s_rotationMatrix2[0] + (s_lensMap[tempacc*4+1]+s_rotationMatrix2[3])*s_rotationMatrix2[1] + (s_disp[2])*s_rotationMatrix2[2])*s_vsize[1]);
 s_rayMap[tempacc*6+2] = ((float)s_size[2]/2.0f + ((s_lensMap[tempacc*4]+s_rotationMatrix1[3])*s_rotationMatrix3[0] + (s_lensMap[tempacc*4+1]+s_rotationMatrix2[3])*s_rotationMatrix3[1] + (s_disp[2])*s_rotationMatrix3[2])*s_vsize[2]);   //scale to original data
 ...
 float temp1= 1.0f/sqrt((s_rayMap[tempacc*6+3]*s_rayMap[tempacc*6+3]+s_rayMap[tempacc*6+4]*s_rayMap[tempacc*6+4]+s_rayMap[tempacc*6+5]*s_rayMap[tempacc*6+5]));
 s_rayMap[tempacc*6+3]*=temp1;
 s_rayMap[tempacc*6+4]*=temp1;
 s_rayMap[tempacc*6+5]*=temp1;
 ...
 while((s_minmaxTrace[tempacc].y-s_minmaxTrace[tempacc].x)>=pos){
   ...
   tempx = __float2int_rn( s_rayMap[tempacc*6+0]+((int)s_minmaxTrace[tempacc].x+pos)*s_rayMap[tempacc*6+3]);
   tempy = __float2int_rn( s_rayMap[tempacc*6+1]+((int)s_minmaxTrace[tempacc].x+pos)*s_rayMap[tempacc*6+4]);
   tempz = __float2int_rn( s_rayMap[tempacc*6+2]+((int)s_minmaxTrace[tempacc].x+pos)*s_rayMap[tempacc*6+5]);
 ...
 */
 ...
 int tempx,tempy,tempz; // variables to store current position
