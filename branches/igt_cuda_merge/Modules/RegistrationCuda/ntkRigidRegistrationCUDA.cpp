#include "ntkRigidRegistrationCUDA.h"

ntkRigidRegistrationCUDA::ntkRigidRegistrationCUDA(){
  m_xpos=0;
  m_ypos=0;
  m_zpos=0;
  m_rxpos=0;
...
void ntkRigidRegistrationCUDA::loadData(ntk3DData *reference){
  m_reference=reference;
  m_measure->loadData(m_reference);
}

void ntkRigidRegistrationCUDA::setInitialPosition(double x, double y, double z, double rx, double ry, double rz){
  m_xpos=x;
  m_ypos=y;
  m_zpos=z;
  m_rxpos=rx;
...
void ntkRigidRegistrationCUDA::doRegistration(ntk3DData* target){
  m_target=target;
...
void ntkRigidRegistrationCUDA::doRegistration(ntk3DData* target, double step, int histFactor){
  m_target=target;
  double temp_value=10000.0;
...
void ntkRigidRegistrationCUDA::doUphillRegistration(ntk3DData* target, double step, double moveStep, int histFactor){
  m_target=target;
  double temp_value=10000.0;
...
void ntkRigidRegistrationCUDA::doPowellRegistration(ntk3DData* target, double stepsize, int histFactor){
  m_target=target;
  double temp_value=10000.0;
  double before_value=0.0;
...
double ntkRigidRegistrationCUDA::optimizeOneDirection(double* variable, double step){
  double big=100000.0;
...
double ntkRigidRegistrationCUDA::optimizeOneDirection(ntkOptimizationStep step){
  double big=100000.0;
  double temp_value=0.0;
  double temp_big=m_value;
...
ntk3DData* ntkRigidRegistrationCUDA::getResult(void){
